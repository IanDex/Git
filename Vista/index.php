...
session_start();
    ...
    $sql = "SELECT id, nombre,correo,color FROM usuarios WHERE id = '$idusuario'";
...
<head>
    ...
    <body data-ma-theme="<?php echo utf8_decode($row['color']); ?>">
        <main class="main">
                ...
                <div class="scrollbar-inner">
                    <div class="user">
                        <div class="user__info" data-toggle="dropdown">
                            ...
                            <div>
                                <div class="user__name"><?php echo utf8_decode($row['nombre']); ?></div>
                                <div class="user__email"><?php echo utf8_decode($row['correo']); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="Login/login2/logout.php">Logout</a>
                        </div>
                    </div>
...
<!-- Mirrored from byrushan.com/projects/material-admin/app/2.1/jquery/bs4/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Apr 2018 15:47:55 GMT -->
</html>